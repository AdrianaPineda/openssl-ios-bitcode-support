Pod::Spec.new do |s|
    ...
    s.source          = { :http => "https://openssl.org/source/openssl-1.1.1c.tar.gz", :sha1 => "71b830a077276cbeccc994369538617a21bee808"}
    ...
    s.prepare_command = <<-CMD
      ...
      curl https://www.openssl.org/source/old/1.1.1/openssl-1.1.1c.tar.gz --output "${CURRENTPATH}/file.tgz"
